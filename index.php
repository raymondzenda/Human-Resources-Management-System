...
<html lang="en">
  ...
  <head>
    ...
    <title>ZINGSA|HRMS</title>
    <link rel="shortcut icon" type="image/x-icon" href="C:/xampp/htdocs/HumanResourceManagement/hris/image/zingsa_logo.png">
    <!-- Bootstrap core CSS -->
  ...
  <body>
	 ...
	 <div class="pull-left">
	  		...
	  		<h1><strong style="position:relative; top:5px;"></strong></br><strong style="position:relative; top:20px;">HUMAN RESOURCE MANAGEMENT SYSTEM</strong><h1>
     </div>
...
<strong style="font-size:50px;">
	  ...
	  <form action="login.php" method="post">
            <centre><h4>Log in</h4><br></centre>
            <p><em>Username:</em>  <input class="form-control" name="user" id="focusedInput" type="text" value="" placeholder="username" style="height:40px;"></em> </p><br>
  ...
  <p><strong style="color:#fff;"><center> Brought To You By ZINGSA</center><strong></p>
