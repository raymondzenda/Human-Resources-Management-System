...
<div class="col-lg-4">
											...
											<div class="input-group input-sm">
												...
												<div class="input-group input-sm">
												<span class="input-group-addon input-sm">Grade No.:</span>
												<input type="text" name="gsis_id_no" class="form-control input-sm" />
											</div>
												<div class="input-group input-sm">
												<span class="input-group-addon input-sm">Date of appointment.:</span>
									...
									<div class="col-lg-4">
											...
											<div class="input-group input-sm">
												...
												<div class="input-group input-sm">
												<span class="input-group-addon input-sm">phone number Code::</span>
