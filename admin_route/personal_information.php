               ...
               <ul class="nav" id="side-menu">
					...
					*/
					?>
                        ...
                        <a href="#" >
						<button type="button" class="btn btn-info btn-circle "><i class="fa fa-table fa-fw fa-lg"></i> </button>
						Employee Information<span class="fa arrow"></span></a>
                           ...
                           <li >
                            ...
                            <li>
								...
								Family Details
							       ...
							       <li>
                                <a href="Educational_Background.php ?id=<?php echo $id; ?>" class="not_active">Academic Background</a>
                            </li>
							       <li>
                        ...
                        <!-- /.nav-second-level -->
							   ...
							   <a href="service_credits.php?id=<?php echo $id; ?>" class="not_active" >
								...
								<i class="fa fa-table fa-fw fa-lg"></i> </button>&nbsp;Leave management module</a>
                            </li>
							       <li>
