...
<html lang="en">
  ...
  <body>
	 ...
	 <img src="image/viclogo.jpg" height="150px;" width="150p;" style="border-radius:100px;position:relative; top:-10px; right:-100px; ">
	  		...
	  		<h1><strong style="position:relative; top:5px;">ZINGSA </strong></br><strong style="position:relative; top:20px;">HUMAN RESOURCE MANAGEMENT SYSTEM</strong><h1>
     </div>
...
<strong style="font-size:50px;">
  ...
  <p><strong style="color:#fff;"><center> All Rights Reserved by zingsa @ 2023.</center><strong></p>
